...
namespace WebAppAPI.Persistence.Repositories
{
    ...
    public class OrderStatusHistoryWriteRepository : WriteRepository<E.OrderStatusHistory>, IOrderStatusHistoryWriteRepository
    {
        // The base constructor expects a parameter.
        public OrderStatusHistoryWriteRepository(WebAppAPIDbContext context) : base(context)
        {
        }
    }
}
