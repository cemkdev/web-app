...
namespace WebAppAPI.Persistence.Repositories
{
    ...
    public class OrderStatusHistoryReadRepository : ReadRepository<E.OrderStatusHistory>, IOrderStatusHistoryReadRepository
    {
        // The base constructor expects a parameter.
        public OrderStatusHistoryReadRepository(WebAppAPIDbContext context) : base(context)
        {
        }
    }
}
